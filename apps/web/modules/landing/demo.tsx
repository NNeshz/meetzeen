export function Demo() {
  return (
    <section className="relative w-full px-4 py-16 md:px-6 lg:px-8 min-h-screen overflow-x-hidden">
      <div className="bg-brand w-[60vw] h-[40vw] max-w-[800px] max-h-[800px] rounded-full absolute top-1/2 -translate-y-1/2 -left-[20vw] blur-3xl opacity-70"/>
      <div className="bg-brand w-[60vw] h-[40vw] max-w-[800px] max-h-[800px] rounded-full absolute top-1/2 -translate-y-1/2 -right-[20vw] blur-3xl opacity-70"/>
